...
<p align="left">
<img width="" height="" src="../images/cpython/0.jpg">
</p>
...
<p align="left">
<img width="" height="" src="../images/cpython/1.gif">
</p>
...
<p align="left">
<img width="" height="" src="../images/cpython/2.gif">
</p>
...
<p align="left">
<img width="" height="" src="../images/cpython/3.gif">
</p>
...
* It is strongly advised to either use `setbuf(stdout, NULL)`; or `fflush(stdout)` in your C functions IF you choose to use `printf`. The reason to that is that Python `s `print `and libCs` s `printf` don’t share the same buffer, and the output can appear disordered.
```
julien@ubuntu:~/CPython$ python3 --version
Python 3.4.3
...
<p align="left">
<img width="" height="" src="../images/cpython/4.gif">
</p>
