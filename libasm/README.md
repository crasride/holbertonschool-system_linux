...
- [x] It stores a pointer to the top of the stack (lowest address)
...
- [ ] It stores a pointer to the program break in the heap
- [x] It stores the address of the current instruction in the code segment
- [ ] It does not have any specific roleue
...
- [ ] It stores a pointer to the program break in the heap
- [ ] It stores the address of the current instruction in the code segment
- [x] It does not have any specific role
...
- [x] Push the value in `rax` in the stack
- [x] Reduce `rsp`
- [ ] Reduce `rbp`
...
- [x] Store the value `16` inside `dil`
- [x] Store the value `16` inside `rdi`
