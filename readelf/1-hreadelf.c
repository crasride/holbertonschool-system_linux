...
{
    FILE *file = NULL;
    int index = 1; // Cambia el índice inicial a 1
    ...
    if (is_32bit) {
        Elf32_Shdr section_header32;
        for (; index <= elf_header32.e_shnum; index++) // Cambia el índice inicial a 1
        {
            char* name = "";
    ...
    {
        Elf64_Shdr section_header64;
        for (; index <= elf_header64.e_shnum; index++) // Cambia el índice inicial a 1
        {
            char* name = "";
